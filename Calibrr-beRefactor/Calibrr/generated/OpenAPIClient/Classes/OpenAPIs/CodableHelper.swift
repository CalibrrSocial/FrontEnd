...
open class CodableHelper {
    ...
    open class func decode<T>(_ type: T.Type, from data: Data) -> Swift.Result<T, Error> where T: Codable {
        return Swift.Result { try jsonDecoder.decode(type, from: data) }
    }

    open class func encode<T>(_ value: T) -> Swift.Result<Data, Error> where T: Codable {
