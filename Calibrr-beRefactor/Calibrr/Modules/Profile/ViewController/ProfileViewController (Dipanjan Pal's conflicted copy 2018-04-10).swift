...
//        self.navigationController?.pushViewController(nextvc, animated: true)
    ...
    func profileViewApi()
    {
        let request = ProfileRequest(user_id: UserDefaults.standard.value(forKey: "user_id") as! String)
        ...
        RequestExecutor.executeRequest(request, completion: {(error: Error?, Response: ProfileModel?) in
            ...
            if Response != nil {
                ...
                if ( Response?.fname != "" ) && (Response?.lname != "")
              {
                ...
                self.lname = Response?.lname
                self.userNameLbl.text = self.fname + " " + self.lname
              }
...
//              }
                ...
                if (Response?.location.isEmpty)!
              {
                ...
                self.livesInLbl.text = Response?.location
              }
               else{
              ...
              if Response?.dob != ""
              {
                ...
                self.dobText.text = Response?.dob
              }
              else{
              ...
              {
                //self.politics = Response?.politics
                self.politicsLbl.text = Response?.politics
              }
               else{
               ...
               if Response?.religion != ""
              {
                ...
                self.religionLbl.text = Response?.religion
              }
               else{
               ...
               if Response?.education != ""
              {
                ...
                self.educationLbl.text = Response?.education
              }
               else{
                
                print("education null")
                
                }
               if Response?.occupation != ""
              {
                //self.occupation = Response?.occupation
                self.occupationLbl.text = Response?.occupation
              }
               else{
                
                print("occupation null")
                
                }
               if Response?.sexuality != ""
              {
               //self.sexuality = Response?.sexuality
                self.sexualityLbl.text = Response?.sexuality
              }
               else{
                
                print("sexuality null")
                
                }
               if Response?.relationship != ""
              {
                //self.relationship = Response?.relationship
                self.relationsLbl.text = Response?.relationship
              }
               else{
                
                print("relationship null")
                
                }
               if Response?.bio != ""
              {
               // self.bio = Response?.bio
                self.bioLbl.text = Response?.bio
              }
               else{
               ...
               if Response?.socialInfo != ""
              {
                self.socialInfo = Response?.socialInfo
              }
              else{
                
                print("socialinfo null")
